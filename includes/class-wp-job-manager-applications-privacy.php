...
class WP_Job_Manager_Applications_Privacy {
	...
	public static function register_user_data_exporter( $exporters ) {
		$exporters['wp-job-manager-applications'] = array(
	...
	public static function register_user_data_eraser( $erasers ) {
		...
		$erasers['wp-job-manager-applications'] = array(
	...
	public static function get_personal_data_fields( $application ) {
		...
		$fields = array(
			'job_name' => array(
				...
				'key'      => 'post_title',
				'type'     => 'post_parent',
				'callback' => array( __CLASS__, 'export_field_job_name' ),
			),
		);
		...
		if ( ! empty( $meta['_attachment'] ) ) {
			$fields['attachment'] = array(
				...
				'type'     => 'meta',
				'key'      => '_attachment',
				'callback' => array( __CLASS__, 'export_field_attachments' ),
			);
		}
